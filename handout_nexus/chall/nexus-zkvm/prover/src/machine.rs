...
impl<C: MachineChip + Sync> Machine<C> {
    ...
    pub fn prove_with_extensions(
        ...
        let d = 1u32;
        println!("d: {}", d);
        let delta = SecureField::from(d);
        let delta = SecureField::from_u32_unchecked(
    1_645_951_658,
    384_541_130,
    1_471_302_658,
    2_042_649_430,
        ...
        all_claimed_sum[0] = all_claimed_sum[0] + delta;
        all_claimed_sum[1] = all_claimed_sum[1] - delta;
